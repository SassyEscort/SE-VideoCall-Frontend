...
const GuestNewPasswordText = lazy(() => import('./GuestNewPassword.styled').then((module) => ({ default: module.GuestNewPasswordText })));
const MainBoxContainer = lazy(() => import('./GuestNewPassword.styled').then((module) => ({ default: module.MainBoxContainer })));
const SecBoxContainer = lazy(() => import('./GuestNewPassword.styled').then((module) => ({ default: module.SecBoxContainer })));
const SecTextContainer = lazy(() => import('./GuestNewPassword.styled').then((module) => ({ default: module.SecTextContainer })));
const SixBoxContainer = lazy(() => import('./GuestNewPassword.styled').then((module) => ({ default: module.SixBoxContainer })));
const ThirdBoxContainer = lazy(() => import('./GuestNewPassword.styled').then((module) => ({ default: module.ThirdBoxContainer })));
