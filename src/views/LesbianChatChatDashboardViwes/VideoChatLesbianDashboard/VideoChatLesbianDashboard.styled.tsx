...
export const LesbianTypography = styled(UINewTypography)(({ theme }) => ({
  fontSize: '26px',
  fontWeight: 400,
  lineHeight: '44.72px',
...
export const LesbianMainContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const LesbianInnerBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(4),
  maxWidth: 993,
...
export const LesbianTableBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  gap: theme.spacing(4)
}));
