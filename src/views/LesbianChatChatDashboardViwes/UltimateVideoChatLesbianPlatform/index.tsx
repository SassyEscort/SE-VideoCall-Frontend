...
} from './UltimateVideoChatLesbianPlatform.styled';
...
const UltimateVideoChatLesbianPlatform = ({ isCustomer }: { isCustomer: boolean }) => {
          ...
          <MeetRealPeopleInnerContainer>
            <MeetRealPeopleBannerInnerBox>
              <HeadingTypography variant="h2">
                <FormattedMessage id="JoinTheFlirtBateLesbian" />
              </HeadingTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="ThousandsOfWomenAre" />
              </SubtitleTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="SignUpNowAndStart" />
              </SubtitleTypography>
            </MeetRealPeopleBannerInnerBox>
            {isCustomer ? (
              <></>
...
export default UltimateVideoChatLesbianPlatform;
