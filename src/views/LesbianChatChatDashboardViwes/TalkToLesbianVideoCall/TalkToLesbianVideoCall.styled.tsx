...
export const TalkToLesbianVideoCallMainContainer = styled(Box)(() => ({
  backgroundImage: 'url(/images/camtocamDashboard/camTocamBackground.webp)',
  width: '100%'
}));

export const TalkToLesbianVideoCallGridContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
...
export const TalkToLesbianVideoCallInnerContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
  gap: theme.spacing(3)
...
export const TalkToLesbianVideoCallBackgroundImageBox = styled(Box)(({ theme }) => ({
