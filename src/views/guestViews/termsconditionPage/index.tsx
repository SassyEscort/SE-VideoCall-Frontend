...
const FirstTextContainer = dynamic(() =>
  import('./TermasAndConditionPage.styled').then((module) => ({ default: module.FirstTextContainer }))
);
const TermsAndConditionMainContainer = dynamic(() =>
