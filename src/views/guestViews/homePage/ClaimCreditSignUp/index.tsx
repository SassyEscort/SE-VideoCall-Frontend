...
const ButtonContainer = lazy(() => import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.ButtonContainer })));
const DescriptionTextBoxContainer = lazy(() =>
  import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.DescriptionTextBoxContainer }))
);
const DialogContentMain = lazy(() => import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.DialogContentMain })));
const DialogTitleBox = lazy(() => import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.DialogTitleBox })));
const FreeCreditSignupMainContainer = lazy(() =>
  import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.FreeCreditSignupMainContainer }))
);
const HeaderCloseButtonBoxContainer = lazy(() =>
  import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.HeaderCloseButtonBoxContainer }))
);
const HeaderTextContainer = lazy(() => import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.HeaderTextContainer })));
const TextInnerBoxContainer = lazy(() =>
  import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.TextInnerBoxContainer }))
);
const TextMainBoxContainer = lazy(() => import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.TextMainBoxContainer })));
const TitleTextBoxContainer = lazy(() =>
  import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.TitleTextBoxContainer }))
);
const TitleTextInnerBoxContainer = lazy(() =>
  import('./ClaimCreditsSignUp.styled').then((module) => ({ default: module.TitleTextInnerBoxContainer }))
);
