...
export const CuckoldTypography = styled(UINewTypography)(({ theme }) => ({
  fontSize: '26px',
  fontWeight: 400,
  lineHeight: '44.72px',
...
export const CuckoldMainContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const CuckoldInnerBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(4),
  maxWidth: 993,
...
export const CuckoldTableBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  gap: theme.spacing(4)
}));
