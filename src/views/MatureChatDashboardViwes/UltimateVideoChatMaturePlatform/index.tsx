...
} from './UltimateVideoChatMaturePlatform.styled';
...
const UltimateVideoChatMaturePlatform = ({ isCustomer }: { isCustomer: boolean }) => {
          ...
          <MeetRealPeopleInnerContainer>
            <MeetRealPeopleBannerInnerBox>
              <HeadingTypography variant="h2">
                <FormattedMessage id="FlirtBateTheUltimateMature" />
              </HeadingTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="WithFlirtBateYouCanMature" />
              </SubtitleTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="JoinNowAndStartYourMature" />
              </SubtitleTypography>
            </MeetRealPeopleBannerInnerBox>
            {isCustomer ? (
              <></>
...
export default UltimateVideoChatMaturePlatform;
