...
export const MatureTypography = styled(UINewTypography)(({ theme }) => ({
  fontSize: '26px',
  fontWeight: 400,
  lineHeight: '44.72px',
...
export const MatureMainContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const MatureInnerBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(4),
  maxWidth: 993,
...
export const MatureTableBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  gap: theme.spacing(4)
}));
