...
export const DirtyWebcamsFingertipsMainContainer = styled(Box)(() => ({
  backgroundImage: 'url(/images/camtocamDashboard/camTocamBackground.webp)',
  width: '100%'
}));

export const DirtyWebcamsFingertipsGridContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
...
export const DirtyWebcamsFingertipsInnerContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
  gap: theme.spacing(3)
...
export const DirtyWebcamsFingertipsBackgroundImageBox = styled(Box)(({ theme }) => ({
