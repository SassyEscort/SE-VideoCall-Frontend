...
export const EnjoyDirtyCamsMainContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
  height: '853px',
...
export const EnjoyDirtyCamsInnerContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const EnjoyDirtyCamsBannerInnerBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(3)
}));
