...
export const TalkToAnonymousStrangerVideoCallMainContainer = styled(Box)(() => ({
  backgroundImage: 'url(/images/camtocamDashboard/camTocamBackground.webp)',
  width: '100%'
}));

export const TalkToAnonymousStrangerVideoCallGridContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
...
export const TalkToAnonymousStrangerVideoCallInnerContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
  gap: theme.spacing(3)
...
export const TalkToAnonymousStrangerVideoCallBackgroundImageBox = styled(Box)(({ theme }) => ({
