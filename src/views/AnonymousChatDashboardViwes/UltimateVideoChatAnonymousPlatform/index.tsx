...
} from './UltimateVideoChatAnonymousPlatform.styled';
...
const UltimateVideoChatAnonymousPlatform = ({ isCustomer }: { isCustomer: boolean }) => {
          ...
          <MeetRealPeopleInnerContainer>
            <MeetRealPeopleBannerInnerBox>
              <HeadingTypography variant="h2">
                <FormattedMessage id="EngageInSecureIntimate" />
              </HeadingTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="WithFlirtBateItsNeverBeenEasier" />
              </SubtitleTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="ReadyToEnjoyAnAnonymous" />
              </SubtitleTypography>
            </MeetRealPeopleBannerInnerBox>
            {isCustomer ? (
              <></>
...
export default UltimateVideoChatAnonymousPlatform;
