...
export const HowChatWorksMainContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const HowChatWorksInnerBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(4),
  maxWidth: 993,
...
export const HowChatWorksTableBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  gap: theme.spacing(4)
}));
