...
export const TalkToStrangerVideoCallMainContainer = styled(Box)(() => ({
  backgroundImage: 'url(/images/camtocamDashboard/camTocamBackground.webp)',
  width: '100%'
}));

export const TalkToStrangerVideoCallGridContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
...
export const TalkToStrangerVideoCallInnerContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
  gap: theme.spacing(3)
...
export const TalkToStrangersVideoCallBackgroundImageBox = styled(Box)(({ theme }) => ({
