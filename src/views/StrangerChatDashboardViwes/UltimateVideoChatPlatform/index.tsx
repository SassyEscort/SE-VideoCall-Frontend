...
} from './UltimateVideoChatPlatform.styled';
...
const UltimateVideoChatPlatform = ({ isCustomer }: { isCustomer: boolean }) => {
          ...
          <MeetRealPeopleInnerContainer>
            <MeetRealPeopleBannerInnerBox>
              <HeadingTypography variant="h2">
                <FormattedMessage id="FlirtBateTheUltimateVideo" />
              </HeadingTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="WithFlirtBateYouCanExplore" />
              </SubtitleTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="JoinNowAndStartYour" />
              </SubtitleTypography>
            </MeetRealPeopleBannerInnerBox>
            {isCustomer ? (
              <></>
...
export default UltimateVideoChatPlatform;
