...
import {
  StrangerChatBanner,
  StrangerChatBannerImg,
  StrangerChatBannerInnerBox,
  StrangerChatBannerInnerBoxContainer,
  StrangerChatBannerUIThemeShadowButton,
  StrangerChatSubTitleText,
  StrangerChatTextContainer,
  StrangerChatTextContainerMain,
  StrangerChatTitleText
} from './StrangerChatMainDashboard.styled';
...
const StrangerChatMainDashboard = () => {
  ...
  return (
    <>
      <StrangerChatBanner>
        <StrangerChatTextContainerMain>
          <StrangerChatTextContainer>
            <StrangerChatBannerInnerBoxContainer sx={{ gap: 6 }} component="div">
              <StrangerChatBannerInnerBoxContainer sx={{ gap: 2 }} component="div">
                <StrangerChatSubTitleText variant="h4">
                  <FormattedMessage id="WELCOMETOFLIRTBATE" />
                </StrangerChatSubTitleText>
                <StrangerChatTitleText variant="h1">
              ...
              <StrangerChatBannerInnerBox>
                ...
                >
                  <StrangerChatBannerUIThemeShadowButton fullWidth variant="contained">
...
export default StrangerChatMainDashboard;
