...
import {
  ButtonBox,
  HeadingTypography,
  PrivateNudeLiveExperienceBannerInnerBox,
  PrivateNudeLiveExperienceInnerContainer,
  PrivateNudeLiveExperienceMainContainer,
  SubtitleTypography
} from './PrivateNudeLiveExperience.styled';
...
const PrivateNudeLiveExperience = ({ isCustomer }: { isCustomer: boolean }) => {
          ...
          <PrivateNudeLiveExperienceInnerContainer>
            <PrivateNudeLiveExperienceBannerInnerBox>
              <HeadingTypography variant="h2">
                <FormattedMessage id="JoinFlirtBateNudeChatNow" />
              </HeadingTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="AtFlirtBateWeBringTheWorld" />
              </SubtitleTypography>
              <SubtitleTypography variant="h6">
                <FormattedMessage id="CreateYourFreeAccountToday" />
              </SubtitleTypography>
            </PrivateNudeLiveExperienceBannerInnerBox>
            {isCustomer ? (
              <></>
...
export default PrivateNudeLiveExperience;
