...
import {
  NudeChatBanner,
  NudeChatBannerImg,
  NudeChatBannerInnerBox,
  NudeChatBannerInnerBoxContainer,
  NudeChatBannerUIThemeShadowButton,
  NudeChatSubTitleText,
  NudeChatTextContainer,
  NudeChatTextContainerMain,
  NudeChatTitleText
} from './NudeChatMainDashboard.styled';
  ...
  return (
    <>
      <NudeChatBanner>
        <NudeChatTextContainerMain>
          <NudeChatTextContainer>
            <NudeChatBannerInnerBoxContainer sx={{ gap: 6 }} component="div">
              <NudeChatBannerInnerBoxContainer sx={{ gap: 2 }} component="div">
                <NudeChatSubTitleText variant="h4">
                  <FormattedMessage id="WELCOMETOFLIRTBATE" />
                </NudeChatSubTitleText>
                <NudeChatTitleText variant="h1">
              ...
              <NudeChatBannerInnerBox>
                ...
                >
                  <NudeChatBannerUIThemeShadowButton fullWidth variant="contained">
...
export default NudeChatMianDashboard;
