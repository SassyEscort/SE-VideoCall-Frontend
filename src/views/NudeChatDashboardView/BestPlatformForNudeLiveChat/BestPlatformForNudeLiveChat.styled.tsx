...
export const BestPlatformForNudeLiveChatMainContainer = styled(Box)(() => ({
  backgroundImage: 'url(/images/camtocamDashboard/camTocamBackground.webp)',
  width: '100%'
}));

export const BestPlatformForNudeLiveChatGridContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
...
export const BestPlatformForNudeLiveChatInnerContainer = styled(Grid)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
  gap: theme.spacing(3)
...
export const BestPlatformForNudeLiveChateBackgroundImageBox = styled(Box)(({ theme }) => ({
