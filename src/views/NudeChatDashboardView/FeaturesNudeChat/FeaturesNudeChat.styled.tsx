...
export const FeaturesNudeChatTypography = styled(UINewTypography)(({ theme }) => ({
  fontSize: '26px',
  fontWeight: 400,
  lineHeight: '44.72px',
...
export const FeaturesNudeChatMainContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const FeaturesNudeChatInnerBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing(4),
  maxWidth: 993,
...
export const FeaturesNudeChatTableBox = styled(Box)(({ theme }) => ({
  display: 'flex',
  gap: theme.spacing(4)
}));
