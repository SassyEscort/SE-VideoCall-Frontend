...
export class GuestAuthService {
  static guestSignup = async (params: SignupParams): Promise<GenericResponse> => {
    try {
      const res = await axios.post<SignupParams, GenericResponseData>(
        process.env.NEXT_PUBLIC_API_BASE_URL + `/v1/customer/signup`,
        params,
        {
